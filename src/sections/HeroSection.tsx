    ...
    >
      <div className="flex flex-col sm:flex-row items-center sm:items-end">
        <div className="flex flex-col gap-6 items-center sm:items-start w-full sm:max-w-[400px] md:max-w-[500px]">
          ...
          <h1
            id="hero-section"
            className="text-center text-xl sm:text-2xl md:text-3xl font-medium sm:text-start"
          >
            Cada sorriso tem uma história e a nossa missão é ajudar você a
            contar a sua da melhor forma.
          </h1>

          <p className="text-center sm:text-start hidden sm:inline-flex">
            Dr. Carlos Alberto é especialista em Ortodontia Estética, oferecendo
            tratamentos personalizados para transformar o seu sorriso com
            tecnologia de ponta.
          </p>

          <button className="bg-linear-to-r bg-steel-blue py-3 rounded-md text-[#fff] font-semibold cursor-pointer hover:bg-steel-blue/90 transition duration-300 mt-2 ease-in-out hover:scale-[1.005] w-full sm:max-w-[300px] mb-8">
            AGENDAR UMA CONSULTA
          </button>
        </div>

        <img
          src="/dentista-carlos-sorrindo.png"
          alt="Dr. Carlos, especialista em ordotondia estética"
      ...
      <div className="border border-x-0 py-4 flex border-sky-blue flex-col gap-6 md:gap-3 shadow-[0_4px_6px_-4px_rgba(0,0,0,0.3)] md:flex-row">
        <div className="flex gap-4 text-[14px] items-center">
          <FaUsers aria-hidden="true" size={42} color="#87ceeb" />
        ...
        <div className="flex gap-4 text-[14px] items-center">
          <IoIosHome aria-hidden="true" size={42} color="#87ceeb " />
          <p className="flex-1 md:max-w-[280px]">
            Cuidado especializado em um espaço elegante e acolhedor, feito para
            você.
          </p>
        </div>

        <div className="flex gap-4 text-[14px] items-center">
          <FaHeartbeat aria-hidden="true" size={42} color="#87ceeb " />
          <p className="flex-1 md:max-w-[280px]">
